  ...
  list: [
    {
      ...
      descriptions: [
        ...
        {
          content:
            'Firebase Authentication을 활용한 이메일/비밀번호·Google 소셜 로그인 기능 구현',
        },
        {
          content:
        ...
        {
          content:
            'html2canvas 기반 결과 공유 이미지 생성 기능 개발(컬러 팔레트·문구 자동 생성)',
        },
        {
          content:
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            'Render 기반 간단한 백엔드 구성 후 배포 파이프라인 구축 (프론트·서버 분리 배포)',
        },
        {
          content:
            'SNS·에브리타임·지인 공유를 통한 홍보를 진행하여 총 방문자 수 11,000+ 기록',
        },
        {
          content: '서비스 URL',
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            'Firebase Authentication을 이용한 Google, Kakao 소셜 로그인 기능 구현',
        },
        {
          content:
            'GPS 기반 이동 거리·페이스 측정 및 SpringBoot API 연동 로직 개발',
        },
        {
          content:
            'Clova STT/TTS API 연동을 통한 음성 기반 AI 러닝 코칭 기능 UI 구축',
        },
        {
          content:
            '러닝 기록 기반 AI 영상 생성 기능 UI 구현 및 백엔드 API 연동',
        },
        {
          content: 'Github Repository',
    ...
    {
      title: '해외 사례 기반 교육 효과 검증을 통한 VR 기업의 교육 분야 진출을 위한 차별화 전략 수립',
      startedAt: '2024-12',
      endedAt: '2025-02',
      ...
      descriptions: [
        ...
        {
          content:
            '해외 연구·논문 기반 데이터셋 구성 및 Python을 활용한 데이터 전처리 수행',
        },
        {
          content:
            'Histogram/KDE 분석을 통한 VR 교육 점수별 미래 관심도 분포 분석',
        },
        {
          content:
        ...
        {
          content:
            'K-means Clustering을 이용하여 VR 기기 보유자 특성 및 군집 패턴 분석',
        },
        {
          content:
            '분석 결과 기반 핵심 인사이트 도출 및 VR 기업 교육 시장 진출 전략 제시',
        },
        {
          content: 'Github Repository',
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            'Firebase Authentication 기반 소셜 로그인 및 사용자 상태 관리 로직 구현',
        },
        {
          content:
        ...
        {
          content:
            'Clova Voice API의 톤 조절 및 낭독 품질 개선을 위한 파라미터 튜닝 수행',
        },
        {
          content: '시연 영상',
