...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    '문제의 원인을 끝까지 추적하고, 안정적으로 동작하는 시스템을 만드는 것을 중요하게 생각하는 개발자 김가은입니다.',
    ...
    'PM 역할을 맡았을 때는 기획서와 기능명세서를 작성하고, Figma로 와이어프레임과 화면설계서를 제작했습니다.',
    '팀 프로젝트에서 팀장·PM 및 백엔드 개발 역할을 맡아 기획·개발·배포·협업 구조 설계까지 주도적으로 수행했으며, 단순 기능 구현을 넘어 유지보수성과 확장성을 고려한 개발을 지향합니다.',
